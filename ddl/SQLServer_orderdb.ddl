...
INSERT INTO category(categoryName) VALUES ('Ceremonial Batik');
INSERT INTO category(categoryName) VALUES ('Casual Batik');

-- Ceremonial Batik
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Batik Truntum', 1, 'Symbol of everlasting love, used in weddings and royal ceremonies.', 28.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Batik Tumpal', 1, 'Geometric pattern often used for religious or royal events.', 22.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Batik Sekar Jagad', 1, 'Floral pattern representing beauty and harmony, ideal for formal occasions.', 35.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Batik Sogan', 1, 'Classic brown batik often used in traditional ceremonies.', 27.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Batik Ceplok', 1, 'Repetitive geometric pattern symbolizing balance and unity.', 24.00);

-- Casual Batik
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Batik Mega Mendung', 2, 'Cloud-inspired design symbolizing patience, perfect for everyday wear.', 30.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Batik Lasem', 2, 'Vibrant red batik from Central Java, suitable for casual outings.', 40.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Batik Kawung', 2, 'Ancient motif with a modern touch, suitable for casual attire.', 20.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Batik Gentongan', 2, 'Colorful Madurese batik, ideal for relaxed settings.', 45.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Batik Parang Lereng', 2, 'Diagonal stripe pattern, simple yet elegant for casual use.', 18.00);

INSERT INTO warehouse(warehouseName) VALUES ('Main warehouse');
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (1, 1, 5, 28.00);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (2, 1, 10, 22.00);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (3, 1, 3, 35.00);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (4, 1, 2, 27.00);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (5, 1, 6, 34.00);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (6, 1, 3, 30.00);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (7, 1, 1, 40.00);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (8, 1, 0, 20.00);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (9, 1, 2, 45.00);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (10, 1, 3, 18.00);
...
DECLARE @orderId int
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (1, '2019-10-15 10:25:55', 114)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 1, 1, 28)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 5, 2, 34)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 10, 1, 18);

DECLARE @orderId int
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (2, '2019-10-16 18:00:00', 170)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 5, 5, 34);

-- Order 3 cannot be shipped as do not have enough inventory for item 7
DECLARE @orderId int
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (3, '2019-10-15 3:30:22', 180)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 6, 2, 30)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 7, 3, 40);

DECLARE @orderId int
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (2, '2019-10-17 05:45:11', 200)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 3, 4, 35)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 8, 3, 20)

DECLARE @orderId int
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (5, '2019-10-15 10:25:55', 136)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 5, 4, 34)
...
-- Customer 1 (Arnold) reviewing Batik Truntum (Product 1)
INSERT INTO review (reviewRating, reviewDate, customerId, productId, reviewComment)
VALUES (5, '2024-12-05 10:30:00', 1, 1, 'Beautiful design and amazing quality! Perfect for special occasions.');

-- Customer 2 (Bobby) reviewing Batik Ceplok (Product 5)
INSERT INTO review (reviewRating, reviewDate, customerId, productId, reviewComment)
VALUES (4, '2024-12-05 11:00:00', 2, 5, 'The pattern is elegant, but I expected a softer fabric.');

-- Customer 5 (Elizabeth) reviewing Batik Parang Lereng (Product 10)
INSERT INTO review (reviewRating, reviewDate, customerId, productId, reviewComment)
VALUES (5, '2024-12-05 12:15:00', 5, 10, 'The design is simple yet classy. A great addition to my collection.');
